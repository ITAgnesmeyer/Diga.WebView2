...
// Type: WebView2.IWebView2Settings
...
namespace Diga.WebView2.Interop
{
  ...
  public interface IWebView2Settings
  {
    ...
    [DispId(1610678278)]
    int IsFullscreenAllowed_deprecated { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
