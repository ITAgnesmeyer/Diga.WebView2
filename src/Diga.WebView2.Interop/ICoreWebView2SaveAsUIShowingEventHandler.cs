...
// Type: Diga.WebView2.Interop.ICoreWebView2SaveAsUIShowingEventHandler
...
namespace Diga.WebView2.Interop
{
  ...
  public interface ICoreWebView2SaveAsUIShowingEventHandler
  {
    ...
    void Invoke([MarshalAs(UnmanagedType.Interface), In] ICoreWebView2 sender, [MarshalAs(UnmanagedType.Interface), In] ICoreWebView2SaveAsUIShowingEventArgs args);
  }
}
