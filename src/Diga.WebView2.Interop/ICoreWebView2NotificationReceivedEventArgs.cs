...
// Type: Diga.WebView2.Interop.ICoreWebView2NotificationReceivedEventArgs
...
namespace Diga.WebView2.Interop
{
  ...
  {
    [DispId(1610678272)]
    string SenderOrigin { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.LPWStr)] get; }

    [DispId(1610678273)]
    ICoreWebView2Notification Notification { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
