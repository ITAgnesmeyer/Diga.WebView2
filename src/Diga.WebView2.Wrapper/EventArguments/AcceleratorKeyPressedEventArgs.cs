...
namespace Diga.WebView2.Wrapper.EventArguments
{
    public class AcceleratorKeyPressedEventArgs: AcceleratorKeyPressedEventArgs2Interface
    {
        ...
        {
            get => (KeyEventType)base.KeyEventKind;
        }

        public new PhysicalKeyStatus PhysicalKeyStatus => new PhysicalKeyStatus(base.PhysicalKeyStatus);
    ...
    //    public AcceleratorKeyPressedEventArgs_o(ICoreWebView2AcceleratorKeyPressedEventArgs args)
    //    {
    //        this._Args = args;
    //    }
