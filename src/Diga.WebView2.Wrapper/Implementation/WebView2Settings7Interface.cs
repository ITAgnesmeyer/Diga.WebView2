    ...
    public class WebView2Settings7Interface : WebView2Settings6Interface
    {
        ...
        private ICoreWebView2Settings7 Settings
        {
            get
            {
                ...
                {
                    Debug.Print(nameof(WebView2Settings7Interface) + "." + nameof(this.Settings) + " is null");
                    throw new InvalidOperationException(nameof(WebView2Settings7Interface) + "." + nameof(this.Settings) + " is null");
