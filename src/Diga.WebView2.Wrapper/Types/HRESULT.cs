...
namespace Diga.WebView2.Wrapper.Types
{
...

    {
        ...
        public override string ToString()
        {
            ...
            if (!dirCodes.TryGetValue(this._value,out fi))
            {
                return this._value.ToString();
            }
            object[] o = fi.GetCustomAttributes(typeof(DescriptionAttribute),false);
            DescriptionAttribute descr = null;
            if (o.Length>0) descr = (DescriptionAttribute)o[0];
            string s = (descr!=null) ? fi.Name + ": " + descr.description : fi.Name;
            return s;
        }
        #endregion

        public bool Failed { get { return this._value < 0; } }
        public bool Succeeded { get { return this._value >= 0; } }
        ...
        /// <summary>
        /// A RunAs specification must be &lt;domain name>\
        /// or simply &lt;user name>
        /// </summary>
    ...
    --*/
        ...
        class DirCodes : System.Collections.DictionaryBase
        {
            ...
            {
                get { return (System.Reflection.FieldInfo)this.Dictionary[key]; }
            ...
            {
                this.Dictionary.Values.CopyTo(values,index);
            }
