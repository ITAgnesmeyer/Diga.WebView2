...
namespace Diga.WebView2.Wrapper.Handler
{
          ...
          ICoreWebView2CreateCoreWebView2EnvironmentCompletedHandler
    {
        ...
        public void Invoke(int result, ICoreWebView2Environment createdEnvironment)
        {
            ...
            OnBeforeEnvironmentCompleted(new EnvironmentCompletedHandlerArgs((ICoreWebView2Environment10)createdEnvironment));
            ...
            OnAfterEnvironmentCompleted(new EnvironmentCompletedHandlerArgs((ICoreWebView2Environment10)createdEnvironment));
            result = HRESULT.S_OK;
        }
