...
{
    public partial class WebView2View : ICoreWebView2_4
    {
        ...
        void ICoreWebView2_3.add_PermissionRequested(ICoreWebView2PermissionRequestedEventHandler eventHandler,
            out EventRegistrationToken token)
        {
            ((ICoreWebView2_3)this._WebView).add_PermissionRequested(eventHandler, out token);
        }

        void ICoreWebView2_3.remove_PermissionRequested(EventRegistrationToken token)
        {
            ((ICoreWebView2_3)this._WebView).remove_PermissionRequested(token);
        }

        void ICoreWebView2_3.add_ProcessFailed(ICoreWebView2ProcessFailedEventHandler eventHandler,
            out EventRegistrationToken token)
        {
            ((ICoreWebView2_3)this._WebView).add_ProcessFailed(eventHandler, out token);
        }

        void ICoreWebView2_3.remove_ProcessFailed(EventRegistrationToken token)
        {
            ((ICoreWebView2_3)this._WebView).remove_ProcessFailed(token);
        }

        void ICoreWebView2_3.AddScriptToExecuteOnDocumentCreated(string javaScript,
            ICoreWebView2AddScriptToExecuteOnDocumentCreatedCompletedHandler handler)
        {
            ((ICoreWebView2_3)this._WebView).AddScriptToExecuteOnDocumentCreated(javaScript, handler);
        }

        void ICoreWebView2_3.add_NavigationStarting(ICoreWebView2NavigationStartingEventHandler eventHandler,
            out EventRegistrationToken token)
        {
            ((ICoreWebView2_3)this._WebView).add_NavigationStarting(eventHandler, out token);
        }
        ...
        {
            return ((ICoreWebView2_3)this._WebView).GetDevToolsProtocolEventReceiver(eventName);
        }
        ...
        {
            ((ICoreWebView2_3) this._WebView).RemoveHostObjectFromScript(name);
        }

        void ICoreWebView2_3.AddHostObjectToScript(string name, ref object @object)
        {
            ((ICoreWebView2_3) this._WebView).AddHostObjectToScript(name, ref @object);
        }
        ...
        {
            ((ICoreWebView2_3) this._WebView).remove_ContainsFullScreenElementChanged(token);
        }

        void ICoreWebView2_3.add_ContainsFullScreenElementChanged(
            ICoreWebView2ContainsFullScreenElementChangedEventHandler eventHandler, out EventRegistrationToken token)
        {
            ((ICoreWebView2_3) this._WebView).add_ContainsFullScreenElementChanged(eventHandler, out token);
        }
        ...
        {
            ((ICoreWebView2_3) this._WebView).remove_WebResourceRequested(token);
        }

        void ICoreWebView2_3.AddWebResourceRequestedFilter(string uri,
            COREWEBVIEW2_WEB_RESOURCE_CONTEXT ResourceContext)
        {
            ((ICoreWebView2_3) this._WebView).AddWebResourceRequestedFilter(uri, ResourceContext);
        }

        void ICoreWebView2_3.RemoveWebResourceRequestedFilter(string uri,
            COREWEBVIEW2_WEB_RESOURCE_CONTEXT ResourceContext)
        {
            ((ICoreWebView2_3) this._WebView).RemoveWebResourceRequestedFilter(uri, ResourceContext);
        }
        ...
        void ICoreWebView2_3.add_WindowCloseRequested(ICoreWebView2WindowCloseRequestedEventHandler eventHandler,
            out EventRegistrationToken token)
        {
            ((ICoreWebView2_3) this._WebView).add_WindowCloseRequested(eventHandler, out token);
        }

        void ICoreWebView2_3.remove_WindowCloseRequested(EventRegistrationToken token)
        {
            ((ICoreWebView2_3) this._WebView).remove_WindowCloseRequested(token);
        }
        ...
        {
            this._WebView.add_FrameCreated(eventHandler, out token);
        }

        void ICoreWebView2_4.remove_FrameCreated(EventRegistrationToken token)
        {
            this._WebView.remove_FrameCreated(token);
        }
        ...
        {
            this._WebView.add_DownloadStarting(eventHandler, out token);
        }

        void ICoreWebView2_4.remove_DownloadStarting(EventRegistrationToken token)
        {
            this._WebView.remove_DownloadStarting(token);
        }
        ...
        ICoreWebView2Settings ICoreWebView2_3.Settings => ((ICoreWebView2_3)this._WebView).Settings;

        int ICoreWebView2_3.CanGoBack => ((ICoreWebView2_3) this._WebView).CanGoBack;

        int ICoreWebView2_3.CanGoForward => ((ICoreWebView2_3) this._WebView).CanGoForward;

        int ICoreWebView2_3.ContainsFullScreenElement => ((ICoreWebView2_3) this._WebView).ContainsFullScreenElement;
        ...
        int ICoreWebView2_4.CanGoBack => this._WebView.CanGoBack;

        int ICoreWebView2_4.CanGoForward => this._WebView.CanGoForward;

        int ICoreWebView2_4.ContainsFullScreenElement => this._WebView.ContainsFullScreenElement;
    }
}