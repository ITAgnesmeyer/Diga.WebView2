...
namespace Diga.WebView2.Interop
{
  ...
  public interface ICoreWebView2MoveFocusRequestedEventHandler
  {
    ...
    void Invoke([MarshalAs(UnmanagedType.Interface), In] ICoreWebView2Host sender, [MarshalAs(UnmanagedType.Interface), In] ICoreWebView2MoveFocusRequestedEventArgs args);
  }
}
